...
<title><s:text name="bshare.points.admin.merchant.edit"/> - <s:text name="bshare.points.admin"/> - <s:text name="bshare.points.title"/></title>
...
<div class="container-center">
	<div class="module-white-grey module-backend">
	    <s:form id="updateMerchantForm" name="updateMerchantForm" action="updateMerchant"
	        method="POST" theme="simple" onsubmit="return verifyForm(this);">
	    <div class="div-gradient-linear-light heading3"><s:text name="bshare.points.admin.merchant.edit" /></div>
	    <div class="wrapper-merchant">
	        <ul>
	            ...
	            <li>
	                ...
	                <input id="name" name="name" type="text" maxlength=40 required="required" style="width:220px;" value="${merchant.name}" />
	            </li>
	            <div class="clear spacer20"></div>
	            <li>
	                ...
	                <input id="homeURL" name="homeURL" type="url" maxlength=100 style="width:220px;" value="${merchant.homeURL}" />
	            </li>
	        </ul>
		    <div class="clear spacer20"></div>
