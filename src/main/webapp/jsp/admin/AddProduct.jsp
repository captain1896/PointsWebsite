...
<title><s:text name="bshare.points.admin.product.add"/> - <s:text name="bshare.points.admin"/> - <s:text name="bshare.points.title"/></title>
...
<style>
    ...
    #showImage { display: none; border: 1px solid #ddd; text-align: center; width: 300px; height: 300px; margin: 0 auto; }
</style>

<div class="container-center">
	<div class="module-white-grey module-backend container-product">
	    <s:form id="createProductForm" name="createProductForm" action="createProduct"
	        method="POST" theme="simple" onsubmit="return verifyForm(this);">
	    <div class="div-gradient-linear-light heading3"><s:text name="bshare.points.admin.product.add" /></div>
	    <div class="wrapper-product">
	        <div class="left" style="width:430px;*width:410px;">
		        <div class="param-div">
	                ...
	                <input id="name" name="name" class="bInput" type="text" maxlength=40 required="required" value="${pointsProduct.name}" />
	            </div>
	            <div class="param-div">
	                <span class="bInputLabel" style="line-height:30px;vertical-align:top;"><s:text name="bshare.points.admin.product.desc" /></span>
	                <span title="<s:text name='bshare.points.admin.product.desc.tip'/>" class="help-popup-img"></span>
	                <textarea id="desc" name="desc" type="text" maxlength=400 onblur="this.value = this.value.substr(0,400);">${pointsProduct.desc}</textarea>
	            </div>
		        <div class="param-div">
	            ...
	            <input id="pic" name="pic" type="hidden" maxlength=150 />
	            <div class="param-div">
	            ...
	            <div class="param-div">
	                ...
	                <input id="priceMarketValue" name="priceMarketValue" class="bInput" step=".01" type="number" min="0.01" max="1000000"
	                    maxlength=250 required="required" value="${pointsProduct.priceMarketValue}"/>
	            </div>
	            <div class="param-div">
	                ...
	                <span style="vertical-align:middle;"><input type="checkbox" id="unlimited" name="unlimited" style="vertical-align:middle;margin:0 3px 3px;" value="true"/>无限库存</span>
	            </div>	            
	            <div class="param-div">
	                ...
	                <input id="initialPoints" name="initialPoints" class="bInput" type="number" onblur="this.value=this.value>0?this.value:0;" maxlength=250 min="1"
	                    required="required" value="${pointsProduct.initialPoints}" />
	            </div>
	            <div class="param-div">
	                ...
	                <input id="currentPoints" name="currentPoints" class="bInput" type="number" onblur="this.value=this.value>0?this.value:0;" maxlength=250 min="1"
	                    required="required" value="${pointsProduct.currentPoints}" />
	            </div>
	            <div class="param-div">
	            ...
	            <div class="param-div">
	                ...
	                <select id="productStatusValue" name="productStatusValue">
	                    <option value="1" selected="selected"><s:text name="bshare.points.admin.product.status.active" /></option>
	        ...
	        <div class="left">
	            ...
	            <span class="bInputLabel" style="line-height:28px;height:28px;">产品图片：</span>
